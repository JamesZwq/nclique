#!/usr/bin/env python3
# Auto-generated for 5547693

STUDENT_ID = "5547693"
STUDENT_NAME = "Liwenqing Liu"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            ...
            if not neighbors:
                continue
            induced = build_induced_subgraph(neighbors)
            k_core = extract_k_core(induced, k)
            if k_core:
                sd[v] = count_connected_components(k_core)
            else:
                sd[v] = 0
        return sd
    ################################################################################
