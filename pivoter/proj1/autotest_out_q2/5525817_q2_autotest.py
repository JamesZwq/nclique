#!/usr/bin/env python3
# Auto-generated for 5525817

STUDENT_ID = "5525817"
STUDENT_NAME = "Yuhang Hou"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        """
        n = G.vertex_num
        sd = [0] * n  # Result list: τ_k(v) for each vertex
        ...
        for v in range(n):
            ...
            # Find connected components in the k-core of the subgraph
    ...
    def _find_k_cores(subgraph, k):
        """
        Compute connected components in the k-core of a given subgraph.
        Parameters
        ----------
        ...
        Returns
        -------
        List[Set[int]] : list of connected components in the k-core
        """
        if not subgraph:
            return []
