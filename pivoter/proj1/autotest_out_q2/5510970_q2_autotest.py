#!/usr/bin/env python3
# Auto-generated for 5510970

STUDENT_ID = "5510970"
STUDENT_NAME = "Xiangyu Zhu"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            ...
            # Compute k-core in this induced subgraph
            core_nodes = kCoreBaseStructuralDiversity.k_core_decomposition(subgraph, k)
            ...
            for node in core_nodes:
                if node not in visited:
                    kCoreBaseStructuralDiversity.bfs(node, core_nodes, subgraph, visited)
                    count += 1
    ...
    @staticmethod
    def bfs(start, core_nodes, subgraph, visited):
        queue = deque([start])
        visited.add(start)
        while queue:
            node = queue.popleft()
