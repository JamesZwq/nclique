#!/usr/bin/env python3
# Auto-generated for 5558339

STUDENT_ID = "5558339"
STUDENT_NAME = "Yiping Wang"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            ...
            subgraph_nodes = neighbor_set.copy()

            subgraph_adj = {}
            degree = {}
            for u in neighbor_set:
                subgraph_adj[u] = [w for w in G.adj_list[u] if w in neighbor_set]
                degree[u] = len(subgraph_adj[u])
