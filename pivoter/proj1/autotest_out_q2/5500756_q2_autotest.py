#!/usr/bin/env python3
# Auto-generated for 5500756

STUDENT_ID = "5500756"
STUDENT_NAME = "Jiayao Mai"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            # Get neighbors and build neighbor-induced subgraph
            ...
            node_to_deg = {}
            for u in neighbors:
                subgraph[u] = [x for x in G.adj_list[u] if x in neighbors]
                node_to_deg[u] = len(subgraph[u])
