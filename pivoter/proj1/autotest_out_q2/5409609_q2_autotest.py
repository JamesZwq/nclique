#!/usr/bin/env python3
# Auto-generated for 5409609

STUDENT_ID = "5409609"
STUDENT_NAME = "Chance Xu"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            ...
            vertex_map = {vertex: i for i, vertex in enumerate(neighbor_list)}
    ...
    def _find_k_cores(adj_list, k):
        ...
        # Use a queue to remove vertices with degree < k
        queue = deque()
        removed = [False] * n
        ...
        # Find remaining vertices (they form k-cores)
