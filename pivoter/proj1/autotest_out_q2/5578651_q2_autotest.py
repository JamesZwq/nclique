#!/usr/bin/env python3
# Auto-generated for 5578651

STUDENT_ID = "5578651"
STUDENT_NAME = "Michael Ly"
...
class kCoreBaseStructuralDiversity(object):
    ...
    def process(G, k):
        ...
        for v in range(n):
            ...
            # Create the neighbour-induced subgraph
            nbr_set = set(neighbours)
            adj = {u: [] for u in nbr_set}
            for u in nbr_set:
                for w in G.adj_list[u]:
                    if w in nbr_set:
                        adj[u].append(w)

            sd[v] = kCoreBaseStructuralDiversity.compute_k_core_components(adj, k)

        return sd

    def compute_k_core_components(adj, k):
        # Peeling algorithm for the k-core
