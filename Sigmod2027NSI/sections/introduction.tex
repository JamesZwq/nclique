...
On \webit, the explicit table behind the same queries would occupy $50.8$\,TB, and it cannot be built at all for $r\ge4$.
%
\nsi{} occupies $1.70$\,MB and answers a point query in $74$ nanoseconds.
%
...
%
Against \cnd{} run serially on the same machine, our builder wins all $42$ grid cells that \cnd{} finishes, by up to $5{,}806\times$, and completes the other $30$ within seconds.
%
On a matched standalone cell it is $742\times$ faster and $226\times$ leaner.
