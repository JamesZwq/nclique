...
Swapping $u$ and $w$ maps $G$ onto itself, so it maps every core $K$ containing $u$ to a core $K'$ of the same size and level containing $w$.
%
If $K$ has a third vertex, the swap leaves that vertex in place, and cores of one size and level that share a vertex are equal, so $K'=K$.
%
...
%
Twin classes have $1.03$ to $1.28$ vertices on average, while \dblp has $13{,}459$ chains for $317{,}080$ vertices ($24$ per chain) and \webuk $839$ chains for $129{,}632$ vertices ($154$ per chain).
%
