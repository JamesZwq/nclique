...
O(1) (3-51 ns) and lists it at memcpy speed or better wherever chains hold a
few dozen vertices; brute-force verified. r >= 2 closed: the paper's size
