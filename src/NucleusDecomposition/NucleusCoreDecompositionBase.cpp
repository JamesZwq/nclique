...
// }
//
// void NucleusCoreDecompositionBase(DynamicGraph<TreeGraphNode> &tree, const Graph &edgeGraph, DynamicGraph<daf::Size> &treeGraphV, daf::CliqueSize r, daf::CliqueSize s) {
