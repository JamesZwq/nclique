...
//
//
//     auto [_, countingRClique] = daf::timeCount("countingPerEdgeAndRClique",
//                                                         [&]() {
//                                                             return CDSetRS::countingPerEdgeAndRClique(
...
//     // std::vector<double> leafCore = CDSetRS::initLeafCore(tree, countingKE, k, edgeGraph);
// #ifndef NDEBUG
//     tree.printGraphPerV();
...
//     bool *currRemovedVertex = new bool[edgeGraph.adj_list.size()];
//     memset(currRemovedVertex, false, edgeGraph.adj_list.size() * sizeof(bool));
...
//     daf::StaticVector<CDSetRS::LeafRmInfo> leafRmInfo(tree.adj_list.size());
...
// #ifndef NDEBUG
//     std::cout << "coreE: ";
//     CDSetRS::printEdgeCore(edgeGraph, coreE);
//     std::cout << "countingKE: ";
//     // CDSetRS::printEdgeCore(edgeGraph, countingKE);
//
//     std::cout << "countingRClique: " << countingRClique << std::endl;
...
//             auto rClique = cliqueIndex.byId(id);
// #ifndef NDEBUG
...
//             CDSetRS::LeafRmInfo &leafRm = leafRmInfo[leafId];
//             if (leaf.empty()) {
