//
// Region Tuple + CPI Counting (V3LM) + Class-Based Hierarchy.
//
...
// Main function: Region CPI LowMem + class-based hierarchy
// ============================================================

std::vector<std::pair<std::vector<daf::Size>, double>>
NucleusCoreDecompositionRClique_RegionCPI_LowMem_Hier(
    ...
    // Per-tuple core value (filled during peeling) and class -> vertices
    // mapping needed by the class-based hierarchy post-processing.
    ...
    // (clear keeps capacity).
    {
        ...
        // classesInRegion and mcCoreVal are retained for hierarchy events.
