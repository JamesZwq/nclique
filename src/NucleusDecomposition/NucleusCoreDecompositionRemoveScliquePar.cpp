...
//                                           [&]() {
//                                               return CDSetRSPar::countingPerRClique(
...
//     // CDSetRSPar::printEdgeCore(edgeGraph, countingKE);
...
//     // CDSetRSPar::printEdgeCore(edgeGraph, degreeE);
// #endif
//
...
//
//     CDSetRSPar::DHeap heap{CDSetRSPar::CompareRClique(countingRClique.data())};
//     heap.reserve(cliqueIndex.size());
//
//     std::vector<CDSetRSPar::DHeap::handle_type> heapHandles(cliqueIndex.size());
//
