...
class DynamicGraphSet {
    public:
        ...
        explicit DynamicGraphSet(const DynamicGraphSet<TreeGraphNode> &treeGraph,
                                daf::Size n,
                                daf::Size minK);
...
std::pair<DynamicGraphSet<daf::Size>,std::vector<Clique>> getCliqueGraph(const DynamicGraphSet<TreeGraphNode> &treeGraph,
