...
int findBestPivotNonNeighborsDegeneracyCliques(int **pivotNonNeighbors, int *numNonNeighbors,
    ...
    while (j < beginR) {
        ...
        int numPotentialNeighbors = MY_MIN(beginR - beginP, numNeighbors[vertex]); //bug resolved by Shweta
    ...
    *numNonNeighbors = beginR - beginP;
    ...
    int numPivotNeighbors = MY_MIN(beginR - beginP, numNeighbors[pivot]); //bug resolved by Shweta
...
void moveToRDegeneracyCliques(int vertex,
    ...
    *pNewBeginR = *pBeginP;
    ...
    while (j < *pNewBeginR) {
        ...
        int numPotentialNeighbors = MY_MIN(sizeOfP, numNeighbors[thisVertex]);
