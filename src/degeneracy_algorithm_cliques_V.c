...
void listAllCliquesDegeneracyRecursive_V(double *cliqueCounts,
                                         ...
                                         int beginX, int beginP, int beginR, int keep, int drop, int *keepV, int *dropV,
                                         int max_k) {
        ...
        while (iterator < numCandidatesToIterateThrough) {
            ...
            if (vertex == pivot) {
                ...
                listAllCliquesDegeneracyRecursive_V(cliqueCounts,
                                                    vertexSets, vertexLookup,
                                                    neighborsInP, numNeighbors,
                                                    newBeginX, newBeginP, newBeginR, keep, drop + 1, keepV, dropV,
                                                    max_k);
            } else {
                keepV[keep] = vertex;
                listAllCliquesDegeneracyRecursive_V(cliqueCounts,
                                                    vertexSets, vertexLookup,
                                                    neighborsInP, numNeighbors,
                                                    newBeginX, newBeginP, newBeginR, keep + 1, drop, keepV, dropV,
                                                    max_k);
            }
