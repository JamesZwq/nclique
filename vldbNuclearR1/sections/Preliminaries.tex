...
%
The \cpi{} is built by a degeneracy-ordered Bron--Kerbosch search with Tomita pivoting~\cite{NuclearCD,BronKerbosch,eppstein,tomita}; we reproduce the construction here as Algorithm~\ref{alg:buildcpi} because the rest of the paper depends on its leaf shape.
