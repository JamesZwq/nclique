...
\item a support recompute for every path-mate $u$ using a freshly enumerated set of $s$-cliques that survive the rewrite, followed by a decrease-key on $u$ in the heap.
\end{itemize}
