...
%
Using the \cpi{} efficiently for the vertex-centric case $r=1$ raises three challenges.
...
The current state of the art for general $(r,s)$-nucleus decomposition is \cbnd~\cite{NuclearCD}, which maintains the \cpi{} as mutable residual state and inherits three weaknesses when restricted to $r=1$.
