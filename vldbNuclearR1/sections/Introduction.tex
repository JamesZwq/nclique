...
%
The dynamic state of a path collapses to a liveness bit and a single integer counter, so the per-peel residual rewrites disappear; the headline RQ1 peel speedup over \cbnd{} on $307$ matched cells is $13.50\times$ in the geometric mean.
