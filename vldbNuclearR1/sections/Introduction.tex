...
%
This representation makes general $(r,s)$-nucleus decomposition practical, but using it efficiently for the vertex-centric case $r=1$ raises two challenges.
...
%
\cbnd{} addresses the general case correctly, but inherits two weaknesses when restricted to $r=1$.
...
%
We address the two challenges with the following contributions, and along the way derive two solvers (\spin{} and \spinStar{}) for computing core values over the static index.
