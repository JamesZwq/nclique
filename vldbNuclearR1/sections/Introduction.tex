...
Even after cheap peeling, \cbnd{} pays the full construction cost; on \texttt{web-it-2004} at \(s=3\), construction takes about \(127\) seconds and peeling takes \(351\) milliseconds, so the static index builder dominates total runtime by \(360\times\) on this configuration.
%
