...
\begin{figure*}[t]
\centering
\includegraphics[width=0.78\linewidth]{figures/fig_scalability_time.pdf}
...
\Description{Two-column log-scale grid showing wall time vs s for five vertex-sample ratios across five graphs (rows), one column per algorithm.}
\label{fig:scalability-time}
\end{figure*}

\begin{figure*}[t]
\centering
\includegraphics[width=0.78\linewidth]{figures/fig_scalability_mem.pdf}
\caption{Vertex-induced scalability: peak RSS under the same protocol as Figure~\ref{fig:scalability-time}.}
\Description{Two-column log-scale grid showing peak RSS vs s for five vertex-sample ratios across five graphs (rows), one column per algorithm.}
