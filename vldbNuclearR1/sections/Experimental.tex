...
%
The benchmark sweep covers \(772\) \((graph,s)\) configurations across the eleven graphs (Table~\ref{tab:datasets}); \(307\) of these are matched cells where both \spinStar{} and \cbnd{} complete successfully, and the headline speedup numbers are reported over the matched subset.

\begin{table}[t]
\centering
\caption{Datasets used in Section~\ref{sec:exp}.}
\label{tab:datasets}
\small
\begin{tabular}{lrrr}
\toprule
