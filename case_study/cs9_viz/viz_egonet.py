...
def render_panel(ax, panel):
    ...
    if peeled:
        ...
        ax.scatter(px, py, s=6, c="#dddddd", linewidths=0, zorder=1)
    ...
    if other_surv:
        ...
        ax.scatter(ox, oy, s=32, c="#bbbbbb", linewidths=0.4,
    ...
    for i, it in enumerate(topK):
        ...
        ax.scatter(cx, cy, s=110, c=[color], edgecolors="white",
                   linewidths=0.7, alpha=0.97, zorder=3)
